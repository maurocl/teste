...
public class z_T4JInternalLazyFactory implements z_T4JInternalFactory {
	...
	public ResponseList<Status> createStatusList(final HttpResponse res)
			throws TwitterException {
		return new LazyResponseList<Status>() {
			@Override
			protected ResponseList<Status> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<Trends> createTrendsList(final HttpResponse res)
			throws TwitterException {
		return new LazyResponseList<Trends>() {
			@Override
			protected ResponseList<Trends> createActualResponseList()
					throws TwitterException {
				return TrendsJSONImpl.createTrendsList(res,
	...
	public ResponseList<User> createUserList(final HttpResponse res)
			throws TwitterException {
		return new LazyResponseList<User>() {
			@Override
			protected ResponseList<User> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<User> createUserListFromJSONArray(final HttpResponse res)
		...
		return new LazyPagableResponseList<User>() {
			...
			protected ResponseList<User> createActualResponseList()
					throws TwitterException {
				return UserJSONImpl
						.createUserList(res.asJSONArray(), res, conf);
			}
		};
	}

	public ResponseList<User> createUserListFromJSONArray_Users(
			final HttpResponse res) throws TwitterException {
		return new LazyPagableResponseList<User>() {
			@Override
			protected ResponseList<User> createActualResponseList()
					throws TwitterException {
				try {
					return UserJSONImpl.createUserList(res.asJSONObject()
							.getJSONArray("users"), res, conf);
	...
	public PagableResponseList<UserList> createPagableUserListList(
		...
		return new LazyPagableResponseList<UserList>() {
			@Override
			protected PagableResponseList<UserList> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<UserList> createUserListList(final HttpResponse res)
		...
		return new LazyResponseList<UserList>() {
			@Override
			protected ResponseList<UserList> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<Category> createCategoryList(final HttpResponse res)
		...
		return new LazyResponseList<Category>() {
			@Override
			protected ResponseList<Category> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<DirectMessage> createDirectMessageList(
		...
		return new LazyResponseList<DirectMessage>() {
			@Override
			protected ResponseList<DirectMessage> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<Friendship> createFriendshipList(final HttpResponse res)
		...
		return new LazyResponseList<Friendship>() {
			@Override
			protected ResponseList<Friendship> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<SavedSearch> createSavedSearchList(
			final HttpResponse res) throws TwitterException {
		return new LazyResponseList<SavedSearch>() {
			@Override
			protected ResponseList<SavedSearch> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<Location> createLocationList(final HttpResponse res)
		...
		return new LazyResponseList<Location>() {
			@Override
			protected ResponseList<Location> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<Place> createPlaceList(final HttpResponse res)
			throws TwitterException {
		return new LazyResponseList<Place>() {
			@Override
			protected ResponseList<Place> createActualResponseList()
					throws TwitterException {
	...
	public ResponseList<HelpMethods.Language> createLanguageList(
			final HttpResponse res) throws TwitterException {
		return new LazyResponseList<HelpMethods.Language>() {
			@Override
			protected ResponseList<HelpMethods.Language> createActualResponseList()
					throws TwitterException {
	...
	public boolean equals(Object o) {
		...
		if (factory != null ? !factory.equals(that.factory)
				: that.factory != null)
			return false;
