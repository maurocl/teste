 ...
 * 
 * <p>É usada para fazer a autenticação do usuário/senha no servidor SMTP.
 * 
 * @author maurocl
 * 
 */
public class MLTechSender extends javax.mail.Authenticator {
	...
	// TODO remover o nome do servidor hardcoded
	...
	public MLTechSender(String user, String password) {
		...
		// TODO remover os dados que estão hardcoded
	...
	/** 
	 * <p>Autentica o usuário e senha
	 * 
	 * @return um objeto responsável pela autenticação do usuário/password.
	 * 
	 */
	...
	/**
	 * <p>Envia um email ao recipiente(s) versando sobre o assunto.
	 * 
	 * @param subject
	 *          Assunto
	 * 
	...
	public synchronized void sendMail(String subject, String body, String sender, String recipients) throws Exception {
		...
		try {
			...
			// adiciona o subjet (assunto do email)
