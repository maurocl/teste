...
public class SessionStore {
   ...
   * 
   * @return true se gravado com sucesso ou false.
   */
   ...
   * 
   * Restaura os valores do access token e expiry date do shared preferences
   * 
   * @param session sessão
   * @param context contexto da aplicação
   * 
  ...
  public static boolean restore(Facebook session, Context context) {
    ...
    // Lê o access token (caso ele não exista retorna null)
