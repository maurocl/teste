...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
  ...
  public CameraPreview(Context context, Camera camera) {
    ...
    //
    // Retorna uma instância do objeto SurfaceHolder que provê acesso e controle
    // sobre
    ...
    // SurfaceHolder is an abstract interface to someone holding a display
    // surface.
    ...
    // SurfaceView, you will want to
    // carefully read the methods lockCanvas() and Callback.surfaceCreated().

    // SurfaceHolder é uma interface abstrata para alguém mantendo sob controle
    // uma superfície de exibição
    // Permite que você controle o tamanho e formato da superfície, editar os
    // pixels na superfície e
    // monitorar mudanças na superfície
    // Essa interface é tipicamente disponível através da classe SurfaceView
    // Quando usar essa interface de uma thread outra da qual aquela rodando a
    // SurfaceView, você irá querer
   ...
   * A superficire (surfcae) foi criada, adquiriu a câmera e diz onde a câmera
   * deve desenhar.<br>
   * 
   * @param holder
  ...
  public void surfaceCreated(SurfaceHolder holder) {
    ...
    try {
      ...
      // preview is necessary to take pictures.
      ...
      // inicia a captura e desenho dos quadros de preview (pré-visualização na
      // tela)
      // a pré-visualização não irá iniciar realmente até que a superfície
      // (surface) seja suprida com os métodos setPreviewDisplay(SurfaceHolder) ou
