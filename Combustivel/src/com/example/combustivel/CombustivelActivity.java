			...
			public void onClick(View v) {
				...
				try {
					...
					if (precoEtanol <= (0.7 * precoGasolina)) {
						...
						editComentario.setText("Abasteça com etanol, pois o preço do etanol representa "+sRazao+"% do valor da gasolina");
						
					} else {
						Log.d(TAG, "Gasolina");
						editEscolha.setText("Gasolina");
						
						editComentario.setText("Abasteça com gasolina, pois o preço do etanol representa "+sRazao+"% do valor da gasolina");
