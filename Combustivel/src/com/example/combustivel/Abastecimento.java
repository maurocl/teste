...
public class Abastecimento extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final EditText editData = (EditText) findViewById(R.id.editGasolina);
		final EditText editKmTotal = (EditText) findViewById(R.id.editEtanol);
			...
			public void onClick(View v) {
				...
				try {
					...
					if ((editValor != null) && (editLitros != null)) {
						...
						editValorPorLitro.setText(String.valueOf(valorPorLitro)
								+ " R$/l");
					...
					if ((editValor != null) && (editValorPorLitro != null)) {
						...
						Log.i(TAG, "Nº de litros = " + valorPorLitro);
